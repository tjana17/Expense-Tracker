...
enum Log {
    ...
    static func success(_ str: String, shouldLogContext: Bool = true, file: String = #file, function: String = #function, line: Int = #line) {
        let context = Context(file: file, function: function, line: line)
        Log.handleLog(level: .success, str: str.description, shouldLogContext: shouldLogContext, context: context)
    }
